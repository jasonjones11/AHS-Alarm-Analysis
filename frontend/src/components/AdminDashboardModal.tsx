...
const AdminDashboardModal: React.FC<AdminDashboardModalProps> = ({ isVisible, onClose }) => {
  ...
  useEffect(() => {
    if (isVisible && licenseInfo?.userType === 'admin') {
      fetchLicenses()
    }
          ...
          <div className="p-6 space-y-6">
            ...
            {showGenerator && (
              <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                <h3 className="text-lg font-semibold text-white mb-4">Generate New License</h3>
                <form onSubmit={generateLicense} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-300 mb-1">User ID (Optional)</label>
                    <input
                      type="text"
            ...
            <div className="bg-gray-800 rounded-lg border border-gray-700">
              <div className="p-4 border-b border-gray-700 flex justify-between items-center">
                <h3 className="text-lg font-semibold text-white">Active Licenses ({licenses.length})</h3>
                <button
                    ...
                    <table className="w-full table-auto">
                      <thead className="bg-gray-700">
                        <tr>
                          ...
                          <th className="px-4 py-2 text-left text-sm font-semibold text-gray-300">MAC Address</th>
                          <th className="px-4 py-2 text-left text-sm font-semibold text-gray-300">Expires</th>
                          <th className="px-4 py-2 text-left text-sm font-semibold text-gray-300">Status</th>
                          <th className="px-4 py-2 text-left text-sm font-semibold text-gray-300">License Key</th>
                        </tr>
                      </thead>
                        ...
                        {licenses.map((license, index) => (
                          <tr key={index} className="hover:bg-gray-700">
                            <td className="px-4 py-3">
                              <div>
                                <div className="font-medium text-gray-100">{license.name}</div>
                            ...
                            <td className="px-4 py-3">
                              <code className="text-sm bg-gray-600 text-gray-100 px-2 py-1 rounded">
                            ...
                            <td className="px-4 py-3">
                              <div className="flex items-center gap-2">
                                <code className="text-xs bg-gray-600 text-gray-100 px-2 py-1 rounded max-w-xs truncate">
                                  {license.license_key}
                                </code>
                                <button
                                  onClick={() => {
