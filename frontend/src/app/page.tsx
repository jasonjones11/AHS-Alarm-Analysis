...
export default function Home() {
  ...
  return (
    <main className="h-screen flex flex-col bg-[#425563] text-white overflow-hidden font-raleway">
      {/* Header */}
      <header className="w-full bg-[#ffc726] p-4 shadow-md flex items-center justify-between flex-shrink-0" style={{ position: 'sticky', top: 0, zIndex: 9999 }}>
        <div className="flex items-center space-x-4">
          ...
          <div className="border-l border-gray-600 pl-4">
            <h1 className="text-2xl font-bold text-[#86c8bc] flex items-center space-x-3">
              <Image
      ...
      <div className="flex flex-1 relative min-h-0">
        ...
        <div className={`bg-[#001e32] border-r border-[#425563] transition-all duration-300 flex-shrink-0 flex flex-col ${
        ...
        {/* Main Content - Map */}
        <div className="flex-1 flex flex-col min-h-0 bg-[#425563]">
          {/* Error Display */}
          {error && (
